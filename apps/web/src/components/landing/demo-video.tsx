...
const SCENES = [
  "→ Sign in — load portable Futuristic identity",
  "✓ Trust root verified",
  "→ Autonomy contract · infrastructure field loaded",
  "→ Bind identity to vehicle surface",
  "✓ Credentials and policy claims evaluated",
  "✓ Portable identity bind logged",
];
        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h2 className="font-display mt-2 text-3xl font-bold md:text-4xl">
              Portable identity bind — live demo
            </h2>
            <p className="mt-3 max-w-xl text-sm text-zinc-400">
              Present portable identity to a vehicle surface and watch credentials, autonomy,
              and infrastructure claims validate in real time.
            </p>
          </div>
        ...
        <div className="mt-10 overflow-hidden rounded-2xl border border-border/60 bg-void shadow-2xl shadow-glow/5">
          <div className="flex items-center gap-2 border-b border-border/40 bg-surface/80 px-4 py-3">
            ...
            <span className="ml-2 font-mono text-[10px] tracking-wider text-muted">
              futuristic — identity.bind.demo
            </span>
          </div>

          <div className="grid lg:grid-cols-2">
            <div className="border-b border-border/40 p-6 lg:border-b-0 lg:border-r">
              <p className="font-mono text-[10px] tracking-wider text-accent">BIND RUNTIME</p>
              <div className="mt-4 space-y-3">
                <div className="rounded-lg border border-border/50 bg-surface/50 p-4">
                  <p className="text-xs text-muted">Identity complete</p>
                ...
                {visible >= 3 && (
                  <div className="rounded-lg border border-glow/30 bg-glow/5 p-4">
                    <p className="text-sm font-medium">Vehicle surface · Model 3</p>
                    <p className="text-xs text-accent">Identity bound</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="p-6 font-mono text-sm">
              <p className="text-muted">$ futuristic bind --surface=vehicle</p>
