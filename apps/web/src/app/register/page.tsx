...
import { Zap, User, Car, Building2 } from "lucide-react";
...
const roles = [
  {
    value: "DRIVER",
    label: "Driver",
    description: "Create your digital driving identity",
    icon: User,
  ...
  },
  {
    ...
    description: "Manage vehicle fleets at scale",
    icon: Building2,
      ...
      <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-12">
        <Card className="w-full max-w-lg">
          <div className="mb-6 text-center">
            ...
            <h1 className="text-2xl font-bold text-white">Create your identity</h1>
            <p className="mt-1 text-sm text-gray-400">
              {step === 1 ? "Choose how you'll use Futuristic" : "Set up your account"}
            </p>
          </div>
                  ...
                  return (
                    ...
                    >
                      <div className={cn(
                        ...
                        role === r.value ? "bg-brand-600 text-white" : "bg-surface-200 text-gray-400",
                      )}>
